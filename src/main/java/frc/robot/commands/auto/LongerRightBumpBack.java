...
public class LongerRightBumpBack extends AutoCommand {

    private PathPlannerPath path1;
    private PathPlannerPath path2;
    
    public LongerRightBumpBack(RobotContainer robot, CommandSwerveDrivetrain drivetrain, SwerveRequest.RobotCentric swerve) {
        path1 = AutoBuildingBlocks.loadPathOrThrow("LongRightBumpBack.1");
        path2 = AutoBuildingBlocks.loadPathOrThrow("LongerRightBumpBack.1");
