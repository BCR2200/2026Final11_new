...
public class LeftBumpCrisis extends AutoCommand {

    private PathPlannerPath path1;
    private PathPlannerPath path2;
    
    public LeftBumpCrisis(RobotContainer robot, CommandSwerveDrivetrain drivetrain, SwerveRequest.RobotCentric swerve) {
        path1 = AutoBuildingBlocks.loadPathOrThrow("LeftBumpCrisisDouble.1");
