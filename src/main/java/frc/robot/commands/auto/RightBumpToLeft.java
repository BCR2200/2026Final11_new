...
public class RightBumpToLeft extends AutoCommand {

    private PathPlannerPath path;
    
    public RightBumpToLeft(RobotContainer robot, CommandSwerveDrivetrain drivetrain, SwerveRequest.RobotCentric swerve) {
        path = AutoBuildingBlocks.loadPathOrThrow("RightBumpToLeft.1");
