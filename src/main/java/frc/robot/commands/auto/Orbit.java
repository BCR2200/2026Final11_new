...
public class Orbit extends AutoCommand {
  private final PathPlannerPath path1;

  public Orbit(RobotContainer robot, CommandSwerveDrivetrain drivetrain, SwerveRequest.RobotCentric swerve) {
    path1 = AutoBuildingBlocks.loadPathOrThrow("Orbit");
